...
//
//    public WordPanel(String letters) {
//        createSquares(letters);
//
//
//    }
//
//    private void createSquares(String letters) {
//                int squareSize = 20;
//                double spacing = 5.5;
//                createText(letters, squareSize, spacing, false );
//                createSquareLetter(letters, squareSize, spacing);
//    }
//    public void createText(String text, int squareSize, double spacing, boolean varLabel) {
